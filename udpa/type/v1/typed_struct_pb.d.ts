 ...
 */
export declare const file_udpa_type_v1_typed_struct: GenFile;
 ...
 *
 * @generated from message udpa.type.v1.TypedStruct
 */
export declare type TypedStruct = Message<"udpa.type.v1.TypedStruct"> & {
  /**
