...
import type { ControlPlane, Node } from "./core/base_pb";
 ...
 */
export declare const file_envoy_api_v2_discovery: GenFile;
 ...
 */
export declare type DiscoveryRequest = Message<"envoy.api.v2.DiscoveryRequest"> & {
  /**
 ...
 */
export declare type DiscoveryResponse = Message<"envoy.api.v2.DiscoveryResponse"> & {
  /**
 ...
 */
export declare type DeltaDiscoveryRequest = Message<"envoy.api.v2.DeltaDiscoveryRequest"> & {
  /**
   * The node making the request.
   *
 ...
 */
export declare type DeltaDiscoveryResponse = Message<"envoy.api.v2.DeltaDiscoveryResponse"> & {
  /**
 ...
 */
export declare type Resource = Message<"envoy.api.v2.Resource"> & {
  /**
