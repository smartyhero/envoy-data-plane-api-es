 ...
 */
export declare const file_envoy_api_v2_core_protocol: GenFile;
 ...
 */
export declare type TcpProtocolOptions = Message<"envoy.api.v2.core.TcpProtocolOptions"> & {
};
 ...
 */
export declare type UpstreamHttpProtocolOptions = Message<"envoy.api.v2.core.UpstreamHttpProtocolOptions"> & {
  /**
 ...
 */
export declare type HttpProtocolOptions = Message<"envoy.api.v2.core.HttpProtocolOptions"> & {
  /**
 ...
 */
export declare type Http1ProtocolOptions = Message<"envoy.api.v2.core.Http1ProtocolOptions"> & {
  /**
 ...
 */
export declare type Http1ProtocolOptions_HeaderKeyFormat = Message<"envoy.api.v2.core.Http1ProtocolOptions.HeaderKeyFormat"> & {
  /**
 ...
 */
export declare type Http1ProtocolOptions_HeaderKeyFormat_ProperCaseWords = Message<"envoy.api.v2.core.Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords"> & {
};
 ...
 */
export declare type Http2ProtocolOptions = Message<"envoy.api.v2.core.Http2ProtocolOptions"> & {
  /**
 ...
 */
export declare type Http2ProtocolOptions_SettingsParameter = Message<"envoy.api.v2.core.Http2ProtocolOptions.SettingsParameter"> & {
  /**
 ...
 */
export declare type GrpcProtocolOptions = Message<"envoy.api.v2.core.GrpcProtocolOptions"> & {
  /**
