...
import type { HealthStatus } from "../core/health_check_pb";
import type { Locality, Metadata } from "../core/base_pb";

/**
 * Describes the file envoy/api/v2/endpoint/endpoint_components.proto.
 */
export declare const file_envoy_api_v2_endpoint_endpoint_components: GenFile;
 ...
 */
export declare type Endpoint = Message<"envoy.api.v2.endpoint.Endpoint"> & {
  /**
 ...
 */
export declare type Endpoint_HealthCheckConfig = Message<"envoy.api.v2.endpoint.Endpoint.HealthCheckConfig"> & {
  /**
 ...
 */
export declare type LbEndpoint = Message<"envoy.api.v2.endpoint.LbEndpoint"> & {
  /**
 ...
 */
export declare type LocalityLbEndpoints = Message<"envoy.api.v2.endpoint.LocalityLbEndpoints"> & {
  /**
