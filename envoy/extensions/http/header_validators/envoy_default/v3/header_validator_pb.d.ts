 ...
 */
export declare const file_envoy_extensions_http_header_validators_envoy_default_v3_header_validator: GenFile;
 ...
 */
export declare type HeaderValidatorConfig = Message<"envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig"> & {
  /**
   * HTTP/1 protocol specific options.
   * These settings control HTTP/1 specific validation behaviors.
   *
   * @generated from field: envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.Http1ProtocolOptions http1_protocol_options = 1;
   */
   ...
   *
   *
   * @generated from field: envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.UriPathNormalizationOptions uri_path_normalization_options = 2;
   */
   ...
   *
   * @generated from field: bool restrict_http_methods = 3;
   */
   ...
   *
   * @generated from field: envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.HeadersWithUnderscoresAction headers_with_underscores_action = 4;
   */
   ...
   *
   * @generated from field: bool strip_fragment_from_path = 5;
   */
 ...
 */
export declare const HeaderValidatorConfigSchema: GenMessage<HeaderValidatorConfig>;
 ...
 */
export declare type HeaderValidatorConfig_UriPathNormalizationOptions = Message<"envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.UriPathNormalizationOptions"> & {
  /**
   ...
   *
   *
   * @generated from field: bool skip_path_normalization = 1;
   */
   ...
   *
   *
   * @generated from field: bool skip_merging_slashes = 2;
   */
   ...
   *
   * @generated from field: envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.UriPathNormalizationOptions.PathWithEscapedSlashesAction path_with_escaped_slashes_action = 3;
   */
 ...
 */
export declare const HeaderValidatorConfig_UriPathNormalizationOptionsSchema: GenMessage<HeaderValidatorConfig_UriPathNormalizationOptions>;
 ...
 */
export declare const HeaderValidatorConfig_UriPathNormalizationOptions_PathWithEscapedSlashesActionSchema: GenEnum<HeaderValidatorConfig_UriPathNormalizationOptions_PathWithEscapedSlashesAction>;
 ...
 */
export declare type HeaderValidatorConfig_Http1ProtocolOptions = Message<"envoy.extensions.http.header_validators.envoy_default.v3.HeaderValidatorConfig.Http1ProtocolOptions"> & {
  /**
   ...
   *
   *
   * @generated from field: bool allow_chunked_length = 1;
   */
 ...
 */
export declare const HeaderValidatorConfig_Http1ProtocolOptionsSchema: GenMessage<HeaderValidatorConfig_Http1ProtocolOptions>;
 ...
 */
export declare const HeaderValidatorConfig_HeadersWithUnderscoresActionSchema: GenEnum<HeaderValidatorConfig_HeadersWithUnderscoresAction>;
