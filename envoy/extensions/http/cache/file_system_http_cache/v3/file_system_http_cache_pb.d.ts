 ...
 */
export declare const file_envoy_extensions_http_cache_file_system_http_cache_v3_file_system_http_cache: GenFile;
 ...
 */
export declare type FileSystemHttpCacheConfig = Message<"envoy.extensions.http.cache.file_system_http_cache.v3.FileSystemHttpCacheConfig"> & {
  /**
 ...
 */
export declare const FileSystemHttpCacheConfigSchema: GenMessage<FileSystemHttpCacheConfig>;
