 ...
 */
export declare const file_envoy_extensions_http_stateful_session_envelope_v3_envelope: GenFile;
 ...
 *
 * @generated from message envoy.extensions.http.stateful_session.envelope.v3.EnvelopeSessionState
 */
export declare type EnvelopeSessionState = Message<"envoy.extensions.http.stateful_session.envelope.v3.EnvelopeSessionState"> & {
  /**
   * Set the header config to track the session state.
   *
   * @generated from field: envoy.extensions.http.stateful_session.envelope.v3.EnvelopeSessionState.Header header = 1;
   */
 ...
 */
export declare const EnvelopeSessionStateSchema: GenMessage<EnvelopeSessionState>;

/**
 * @generated from message envoy.extensions.http.stateful_session.envelope.v3.EnvelopeSessionState.Header
 */
export declare type EnvelopeSessionState_Header = Message<"envoy.extensions.http.stateful_session.envelope.v3.EnvelopeSessionState.Header"> & {
  /**
 ...
 */
export declare const EnvelopeSessionState_HeaderSchema: GenMessage<EnvelopeSessionState_Header>;
