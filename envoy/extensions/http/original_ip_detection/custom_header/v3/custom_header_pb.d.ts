 ...
 */
export declare const file_envoy_extensions_http_original_ip_detection_custom_header_v3_custom_header: GenFile;
 ...
 */
export declare type CustomHeaderConfig = Message<"envoy.extensions.http.original_ip_detection.custom_header.v3.CustomHeaderConfig"> & {
  /**
 ...
 */
export declare const CustomHeaderConfigSchema: GenMessage<CustomHeaderConfig>;
