 ...
 */
export declare const file_envoy_extensions_retry_priority_previous_priorities_v3_previous_priorities_config: GenFile;
 ...
 *
 * @generated from message envoy.extensions.retry.priority.previous_priorities.v3.PreviousPrioritiesConfig
 */
export declare type PreviousPrioritiesConfig = Message<"envoy.extensions.retry.priority.previous_priorities.v3.PreviousPrioritiesConfig"> & {
  /**
   ...
   *
   * @generated from field: int32 update_frequency = 1;
   */
 ...
 */
export declare const PreviousPrioritiesConfigSchema: GenMessage<PreviousPrioritiesConfig>;
