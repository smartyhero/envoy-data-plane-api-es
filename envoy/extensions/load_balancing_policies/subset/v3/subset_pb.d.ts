 ...
 */
export declare const file_envoy_extensions_load_balancing_policies_subset_v3_subset: GenFile;
 ...
 */
export declare type Subset = Message<"envoy.extensions.load_balancing_policies.subset.v3.Subset"> & {
  /**
   ...
   *
   *
   * @generated from field: bool allow_redundant_keys = 10;
   */
 ...
 */
export declare const SubsetSchema: GenMessage<Subset>;
 ...
 */
export declare type Subset_LbSubsetSelector = Message<"envoy.extensions.load_balancing_policies.subset.v3.Subset.LbSubsetSelector"> & {
  /**
 ...
 */
export declare const Subset_LbSubsetSelectorSchema: GenMessage<Subset_LbSubsetSelector>;
 ...
 */
export declare const Subset_LbSubsetSelector_LbSubsetSelectorFallbackPolicySchema: GenEnum<Subset_LbSubsetSelector_LbSubsetSelectorFallbackPolicy>;
 ...
 */
export declare const Subset_LbSubsetFallbackPolicySchema: GenEnum<Subset_LbSubsetFallbackPolicy>;
 ...
 */
export declare const Subset_LbSubsetMetadataFallbackPolicySchema: GenEnum<Subset_LbSubsetMetadataFallbackPolicy>;
