...
import type { ProcessingMode } from "./processing_mode_pb";
import type { Duration } from "@bufbuild/protobuf/wkt";
import type { HeaderMutationRules } from "../../../../../config/common/mutation_rules/v3/mutation_rules_pb";
...
import type { ListStringMatcher } from "../../../../../type/matcher/v3/string_pb";
 ...
 */
export declare const file_envoy_extensions_filters_http_ext_proc_v3_ext_proc: GenFile;
 ...
 */
export declare type ExternalProcessor = Message<"envoy.extensions.filters.http.ext_proc.v3.ExternalProcessor"> & {
  /**
   ...
   *
   *
   * @generated from field: envoy.extensions.filters.http.ext_proc.v3.ExtProcHttpService http_service = 20;
   */
   ...
   *
   * @generated from field: bool disable_immediate_response = 15;
   */
  disableImmediateResponse: boolean;

  /**
   * Options related to the sending and receiving of dynamic metadata.
   *
   * @generated from field: envoy.extensions.filters.http.ext_proc.v3.MetadataOptions metadata_options = 16;
   */
   ...
   *
   *
   * @generated from field: bool observability_mode = 17;
   */
   ...
   * Only one of ``disable_clear_route_cache`` or ``route_cache_action`` can be set.
   *
   * @generated from field: envoy.extensions.filters.http.ext_proc.v3.ExternalProcessor.RouteCacheAction route_cache_action = 18;
   */
   ...
   *
   * @generated from field: google.protobuf.Duration deferred_close_timeout = 19;
   */
  deferredCloseTimeout?: Duration;
   ...
   *
   * @generated from field: bool send_body_without_waiting_for_header_response = 21;
   */
   ...
   *
   * @generated from field: repeated envoy.extensions.filters.http.ext_proc.v3.ProcessingMode allowed_override_modes = 22;
   */
   ...
   *
   * @generated from field: envoy.config.core.v3.TypedExtensionConfig processing_request_modifier = 25;
   */
  processingRequestModifier?: TypedExtensionConfig;
   ...
   *
   * @generated from field: envoy.config.core.v3.TypedExtensionConfig on_processing_response = 23;
   */
  onProcessingResponse?: TypedExtensionConfig;
   ...
   *
   * @generated from field: envoy.type.v3.HttpStatus status_on_error = 24;
   */
 ...
 */
export declare const ExternalProcessorSchema: GenMessage<ExternalProcessor>;
 ...
 */
export declare const ExternalProcessor_RouteCacheActionSchema: GenEnum<ExternalProcessor_RouteCacheAction>;

/**
 * ExtProcHttpService is used for HTTP communication between the filter and the external processing service.
 *
 * @generated from message envoy.extensions.filters.http.ext_proc.v3.ExtProcHttpService
 */
export declare type ExtProcHttpService = Message<"envoy.extensions.filters.http.ext_proc.v3.ExtProcHttpService"> & {
  /**
   * Sets the HTTP service which the external processing requests must be sent to.
   *
   * @generated from field: envoy.config.core.v3.HttpService http_service = 1;
   */
 ...
 */
export declare const ExtProcHttpServiceSchema: GenMessage<ExtProcHttpService>;
 ...
 *
 * @generated from message envoy.extensions.filters.http.ext_proc.v3.MetadataOptions
 */
export declare type MetadataOptions = Message<"envoy.extensions.filters.http.ext_proc.v3.MetadataOptions"> & {
  /**
   * Describes which typed or untyped dynamic metadata namespaces to forward to
   * the external processing server.
   *
   * @generated from field: envoy.extensions.filters.http.ext_proc.v3.MetadataOptions.MetadataNamespaces forwarding_namespaces = 1;
   */
   ...
   *
   * @generated from field: envoy.extensions.filters.http.ext_proc.v3.MetadataOptions.MetadataNamespaces receiving_namespaces = 2;
   */
...
/**
 * @generated from message envoy.extensions.filters.http.ext_proc.v3.MetadataOptions.MetadataNamespaces
 */
export declare type MetadataOptions_MetadataNamespaces = Message<"envoy.extensions.filters.http.ext_proc.v3.MetadataOptions.MetadataNamespaces"> & {
  /**
 ...
 */
export declare type HeaderForwardingRules = Message<"envoy.extensions.filters.http.ext_proc.v3.HeaderForwardingRules"> & {
  /**
 ...
 */
export declare const HeaderForwardingRulesSchema: GenMessage<HeaderForwardingRules>;
 ...
 */
export declare type ExtProcPerRoute = Message<"envoy.extensions.filters.http.ext_proc.v3.ExtProcPerRoute"> & {
  /**
 ...
 */
export declare const ExtProcPerRouteSchema: GenMessage<ExtProcPerRoute>;
 ...
 */
export declare type ExtProcOverrides = Message<"envoy.extensions.filters.http.ext_proc.v3.ExtProcOverrides"> & {
  /**
   ...
   *
   * @generated from field: bool async_mode = 2 [deprecated = true];
   * @deprecated
   */
  asyncMode: boolean;
   ...
   *
   * @generated from field: envoy.extensions.filters.http.ext_proc.v3.MetadataOptions metadata_options = 6;
   */
  metadataOptions?: MetadataOptions;
   ...
   *
   * @generated from field: repeated envoy.config.core.v3.HeaderValue grpc_initial_metadata = 7;
   */
  grpcInitialMetadata: HeaderValue[];
   ...
   *
   * @generated from field: google.protobuf.BoolValue failure_mode_allow = 8;
   */
  failureModeAllow?: boolean;
   ...
   *
   * @generated from field: envoy.config.core.v3.TypedExtensionConfig processing_request_modifier = 9;
   */
  processingRequestModifier?: TypedExtensionConfig;
};
 ...
 */
export declare const ExtProcOverridesSchema: GenMessage<ExtProcOverrides>;
