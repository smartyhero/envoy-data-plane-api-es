...
import type { HeaderValue, RetryPolicy, RuntimeFeatureFlag, RuntimeFractionalPercent } from "../../../../../config/core/v3/base_pb";
 ...
 */
export declare const file_envoy_extensions_filters_http_ext_authz_v3_ext_authz: GenFile;
 ...
 */
export declare type ExtAuthz = Message<"envoy.extensions.filters.http.ext_authz.v3.ExtAuthz"> & {
  /**
   ...
   * HTTP 5xx error.
   *
   * @generated from field: bool failure_mode_allow_header_add = 19;
   */
  failureModeAllowHeaderAdd: boolean;
   ...
   *
   * @generated from field: bool validate_mutations = 24;
   */
   ...
   *
   * @generated from field: repeated string route_metadata_context_namespaces = 21;
   */
   ...
   *
   * @generated from field: repeated string route_typed_metadata_context_namespaces = 22;
   */
   ...
   *
   * @generated from field: envoy.type.matcher.v3.ListStringMatcher disallowed_headers = 25;
   */
   ...
   * Defaults to ``true``.
   *
   * @generated from field: google.protobuf.BoolValue charge_cluster_response_stats = 20;
   */
  chargeClusterResponseStats?: boolean;
   ...
   *
   * @generated from field: bool encode_raw_headers = 23;
   */
  encodeRawHeaders: boolean;
   ...
   *
   * @generated from field: envoy.config.common.mutation_rules.v3.HeaderMutationRules decoder_header_mutation_rules = 26;
   */
   ...
   *
   * @generated from field: google.protobuf.BoolValue enable_dynamic_metadata_ingestion = 27;
   */
  enableDynamicMetadataIngestion?: boolean;
   ...
   * name.
   *
   * @generated from field: google.protobuf.Struct filter_metadata = 28;
   */
   ...
   *
   * @generated from field: bool emit_filter_state_stats = 29;
   */
   ...
   *
   * @generated from field: uint32 max_denied_response_body_bytes = 30;
   */
  maxDeniedResponseBodyBytes: number;
};
 ...
 */
export declare type BufferSettings = Message<"envoy.extensions.filters.http.ext_authz.v3.BufferSettings"> & {
  /**
 ...
 */
export declare type HttpService = Message<"envoy.extensions.filters.http.ext_authz.v3.HttpService"> & {
  /**
   ...
   *
   * @generated from field: envoy.config.core.v3.RetryPolicy retry_policy = 9;
   */
 ...
 */
export declare type AuthorizationRequest = Message<"envoy.extensions.filters.http.ext_authz.v3.AuthorizationRequest"> & {
  /**
 ...
 */
export declare type AuthorizationResponse = Message<"envoy.extensions.filters.http.ext_authz.v3.AuthorizationResponse"> & {
  /**
 ...
 */
export declare type ExtAuthzPerRoute = Message<"envoy.extensions.filters.http.ext_authz.v3.ExtAuthzPerRoute"> & {
  /**
 ...
 */
export declare type CheckSettings = Message<"envoy.extensions.filters.http.ext_authz.v3.CheckSettings"> & {
  /**
   ...
   * may be specified.
   *
   * @generated from field: envoy.extensions.filters.http.ext_authz.v3.BufferSettings with_request_body = 3;
   */
  withRequestBody?: BufferSettings;
   ...
   *
   * @generated from oneof envoy.extensions.filters.http.ext_authz.v3.CheckSettings.service_override
   */
  serviceOverride: {
    /**
     * Override with a gRPC service configuration.
     *
     * @generated from field: envoy.config.core.v3.GrpcService grpc_service = 4;
     */
    value: GrpcService;
    case: "grpcService";
  } | {
     ...
     *
     * @generated from field: envoy.extensions.filters.http.ext_authz.v3.HttpService http_service = 5;
     */
    value: HttpService;
    case: "httpService";
  } | { case: undefined; value?: undefined };
