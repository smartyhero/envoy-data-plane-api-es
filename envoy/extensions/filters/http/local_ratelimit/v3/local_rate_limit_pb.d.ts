...
import type { LocalClusterRateLimit, LocalRateLimitDescriptor, VhRateLimitsOptions, XRateLimitHeadersRFCVersion } from "../../../../common/ratelimit/v3/ratelimit_pb";
import type { RateLimit } from "../../../../../config/route/v3/route_components_pb";

/**
 * Describes the file envoy/extensions/filters/http/local_ratelimit/v3/local_rate_limit.proto.
 */
export declare const file_envoy_extensions_filters_http_local_ratelimit_v3_local_rate_limit: GenFile;
 ...
 */
export declare type LocalRateLimit = Message<"envoy.extensions.filters.http.local_ratelimit.v3.LocalRateLimit"> & {
  /**
   ...
   *
   * @generated from field: envoy.extensions.common.ratelimit.v3.LocalClusterRateLimit local_cluster_rate_limit = 16;
   */
  localClusterRateLimit?: LocalClusterRateLimit;
   ...
   *
   * @generated from field: google.protobuf.BoolValue always_consume_default_token_bucket = 14;
   */
   ...
   *
   * @generated from field: bool rate_limited_as_resource_exhausted = 15;
   */
   ...
   *
   * @generated from field: google.protobuf.UInt32Value max_dynamic_descriptors = 18;
   */
  maxDynamicDescriptors?: number;
};
