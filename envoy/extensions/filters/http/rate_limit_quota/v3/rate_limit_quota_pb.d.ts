 ...
 */
export declare const file_envoy_extensions_filters_http_rate_limit_quota_v3_rate_limit_quota: GenFile;
 ...
 */
export declare type RateLimitQuotaFilterConfig = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaFilterConfig"> & {
  /**
 ...
 */
export declare const RateLimitQuotaFilterConfigSchema: GenMessage<RateLimitQuotaFilterConfig>;
 ...
 */
export declare type RateLimitQuotaOverride = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaOverride"> & {
  /**
   * The application domain to use when calling the service. This enables sharing the quota
   * server between different applications without fear of overlap.
   * E.g., "envoy".
 ...
 */
export declare const RateLimitQuotaOverrideSchema: GenMessage<RateLimitQuotaOverride>;
 ...
 */
export declare type RateLimitQuotaBucketSettings = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings"> & {
  /**
   * ``BucketId`` builder.
   *
 ...
 */
export declare const RateLimitQuotaBucketSettingsSchema: GenMessage<RateLimitQuotaBucketSettings>;
 ...
 */
export declare type RateLimitQuotaBucketSettings_NoAssignmentBehavior = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.NoAssignmentBehavior"> & {
  /**
 ...
 */
export declare const RateLimitQuotaBucketSettings_NoAssignmentBehaviorSchema: GenMessage<RateLimitQuotaBucketSettings_NoAssignmentBehavior>;
 ...
 */
export declare type RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.ExpiredAssignmentBehavior"> & {
  /**
 ...
 */
export declare const RateLimitQuotaBucketSettings_ExpiredAssignmentBehaviorSchema: GenMessage<RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior>;
 ...
 */
export declare type RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior_ReuseLastAssignment = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.ExpiredAssignmentBehavior.ReuseLastAssignment"> & {
};
 ...
 */
export declare const RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior_ReuseLastAssignmentSchema: GenMessage<RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior_ReuseLastAssignment>;
 ...
 */
export declare type RateLimitQuotaBucketSettings_DenyResponseSettings = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.DenyResponseSettings"> & {
  /**
 ...
 */
export declare const RateLimitQuotaBucketSettings_DenyResponseSettingsSchema: GenMessage<RateLimitQuotaBucketSettings_DenyResponseSettings>;
 ...
 */
export declare type RateLimitQuotaBucketSettings_BucketIdBuilder = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.BucketIdBuilder"> & {
  /**
 ...
 */
export declare const RateLimitQuotaBucketSettings_BucketIdBuilderSchema: GenMessage<RateLimitQuotaBucketSettings_BucketIdBuilder>;
 ...
 */
export declare type RateLimitQuotaBucketSettings_BucketIdBuilder_ValueBuilder = Message<"envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.BucketIdBuilder.ValueBuilder"> & {
  /**
 ...
 */
export declare const RateLimitQuotaBucketSettings_BucketIdBuilder_ValueBuilderSchema: GenMessage<RateLimitQuotaBucketSettings_BucketIdBuilder_ValueBuilder>;
