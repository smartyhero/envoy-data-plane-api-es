 ...
 */
export declare const file_envoy_extensions_filters_http_custom_response_v3_custom_response: GenFile;
 ...
 */
export declare type CustomResponse = Message<"envoy.extensions.filters.http.custom_response.v3.CustomResponse"> & {
  /**
 ...
 */
export declare const CustomResponseSchema: GenMessage<CustomResponse>;
