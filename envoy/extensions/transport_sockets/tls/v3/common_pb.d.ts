...
import type { DataSource, WatchedDirectory } from "../../../../config/core/v3/base_pb";
 ...
 */
export declare const file_envoy_extensions_transport_sockets_tls_v3_common: GenFile;
 ...
 */
export declare type TlsParameters = Message<"envoy.extensions.transport_sockets.tls.v3.TlsParameters"> & {
  /**
   ...
   *
   * @generated from field: repeated envoy.extensions.transport_sockets.tls.v3.TlsParameters.CompliancePolicy compliance_policies = 6;
   */
  compliancePolicies: TlsParameters_CompliancePolicy[];
};
...
export enum TlsParameters_CompliancePolicy {
   ...
   *   for details.
   *
   * @generated from enum value: FIPS_202205 = 0;
   */
  FIPS_202205 = 0,
}
 ...
 */
export declare const TlsParameters_CompliancePolicySchema: GenEnum<TlsParameters_CompliancePolicy>;
 ...
 */
export declare type PrivateKeyProvider = Message<"envoy.extensions.transport_sockets.tls.v3.PrivateKeyProvider"> & {
  /**
 ...
 */
export declare type TlsCertificate = Message<"envoy.extensions.transport_sockets.tls.v3.TlsCertificate"> & {
  /**
 ...
 */
export declare type TlsSessionTicketKeys = Message<"envoy.extensions.transport_sockets.tls.v3.TlsSessionTicketKeys"> & {
  /**
 ...
 */
export declare type CertificateProviderPluginInstance = Message<"envoy.extensions.transport_sockets.tls.v3.CertificateProviderPluginInstance"> & {
  /**
 ...
 */
export declare const CertificateProviderPluginInstanceSchema: GenMessage<CertificateProviderPluginInstance>;
 ...
 */
export declare type SubjectAltNameMatcher = Message<"envoy.extensions.transport_sockets.tls.v3.SubjectAltNameMatcher"> & {
  /**
 ...
 */
export declare const SubjectAltNameMatcherSchema: GenMessage<SubjectAltNameMatcher>;
...
export enum SubjectAltNameMatcher_SanType {
  ...
  /**
   * @generated from enum value: OTHER_NAME = 5;
   */
  OTHER_NAME = 5,
}
 ...
 */
export declare const SubjectAltNameMatcher_SanTypeSchema: GenEnum<SubjectAltNameMatcher_SanType>;
 ...
 */
export declare type CertificateValidationContext = Message<"envoy.extensions.transport_sockets.tls.v3.CertificateValidationContext"> & {
  /**
   ...
   * [#not-implemented-hide:]
   *
   * @generated from field: envoy.extensions.transport_sockets.tls.v3.CertificateValidationContext.SystemRootCerts system_root_certs = 17;
   */
  systemRootCerts?: CertificateValidationContext_SystemRootCerts;
...
/**
 * @generated from message envoy.extensions.transport_sockets.tls.v3.CertificateValidationContext.SystemRootCerts
 */
export declare type CertificateValidationContext_SystemRootCerts = Message<"envoy.extensions.transport_sockets.tls.v3.CertificateValidationContext.SystemRootCerts"> & {
};
 ...
 */
export declare const CertificateValidationContext_SystemRootCertsSchema: GenMessage<CertificateValidationContext_SystemRootCerts>;
