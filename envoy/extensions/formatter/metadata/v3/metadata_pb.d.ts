 ...
 */
export declare const file_envoy_extensions_formatter_metadata_v3_metadata: GenFile;
 ...
 */
export declare type Metadata = Message<"envoy.extensions.formatter.metadata.v3.Metadata"> & {
};
