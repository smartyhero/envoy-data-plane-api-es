 ...
 */
export declare const file_envoy_config_core_v3_protocol: GenFile;
 ...
 */
export declare type TcpProtocolOptions = Message<"envoy.config.core.v3.TcpProtocolOptions"> & {
};
 ...
 */
export declare type QuicKeepAliveSettings = Message<"envoy.config.core.v3.QuicKeepAliveSettings"> & {
  /**
   ...
   *
   * @generated from field: google.protobuf.Duration max_interval = 1;
   */
 ...
 */
export declare const QuicKeepAliveSettingsSchema: GenMessage<QuicKeepAliveSettings>;
 ...
 */
export declare type QuicProtocolOptions = Message<"envoy.config.core.v3.QuicProtocolOptions"> & {
  /**
   ...
   *
   * @generated from field: google.protobuf.UInt32Value initial_stream_window_size = 2;
   */
   ...
   *
   *
   * @generated from field: google.protobuf.UInt32Value initial_connection_window_size = 3;
   */
   ...
   *
   * @generated from field: google.protobuf.UInt32Value num_timeouts_to_trigger_port_migration = 4;
   */
  numTimeoutsToTriggerPortMigration?: number;
   ...
   *
   * @generated from field: envoy.config.core.v3.QuicKeepAliveSettings connection_keepalive = 5;
   */
   ...
   *
   * @generated from field: string connection_options = 6;
   */
   ...
   * `QUICHE <https://github.com/google/quiche/blob/main/quiche/quic/core/crypto/crypto_protocol.h>`_ and to be sent by upstream connections.
   *
   * @generated from field: string client_connection_options = 7;
   */
   ...
   *
   * @generated from field: google.protobuf.Duration idle_network_timeout = 8;
   */
  idleNetworkTimeout?: Duration;
   ...
   *
   * @generated from field: google.protobuf.UInt64Value max_packet_length = 9;
   */
 ...
 */
export declare type UpstreamHttpProtocolOptions = Message<"envoy.config.core.v3.UpstreamHttpProtocolOptions"> & {
  /**
   ...
   * Does nothing if a filter before the http router filter sets the corresponding metadata.
   *
   * @generated from field: string override_auto_sni_header = 3;
   */
 ...
 */
export declare const UpstreamHttpProtocolOptionsSchema: GenMessage<UpstreamHttpProtocolOptions>;
 ...
 */
export declare type AlternateProtocolsCacheOptions = Message<"envoy.config.core.v3.AlternateProtocolsCacheOptions"> & {
  /**
   ...
   *
   * @generated from field: google.protobuf.UInt32Value max_entries = 2;
   */
  maxEntries?: number;
   ...
   *
   * @generated from field: envoy.config.core.v3.TypedExtensionConfig key_value_store_config = 3;
   */
   ...
   *
   * @generated from field: repeated envoy.config.core.v3.AlternateProtocolsCacheOptions.AlternateProtocolsCacheEntry prepopulated_entries = 4;
   */
   ...
   * [#not-implemented-hide:]
   *
   * @generated from field: repeated string canonical_suffixes = 5;
   */
 ...
 */
export declare const AlternateProtocolsCacheOptionsSchema: GenMessage<AlternateProtocolsCacheOptions>;
 ...
 */
export declare type AlternateProtocolsCacheOptions_AlternateProtocolsCacheEntry = Message<"envoy.config.core.v3.AlternateProtocolsCacheOptions.AlternateProtocolsCacheEntry"> & {
  /**
 ...
 */
export declare const AlternateProtocolsCacheOptions_AlternateProtocolsCacheEntrySchema: GenMessage<AlternateProtocolsCacheOptions_AlternateProtocolsCacheEntry>;
 ...
 */
export declare type HttpProtocolOptions = Message<"envoy.config.core.v3.HttpProtocolOptions"> & {
  /**
   ...
   *
   *
   * @generated from field: google.protobuf.UInt32Value max_response_headers_kb = 7;
   */
  maxResponseHeadersKb?: number;
   ...
   *
   * @generated from field: envoy.config.core.v3.HttpProtocolOptions.HeadersWithUnderscoresAction headers_with_underscores_action = 5;
   */
   ...
   *
   * @generated from field: google.protobuf.UInt32Value max_requests_per_connection = 6;
   */
 ...
 */
export declare const HttpProtocolOptions_HeadersWithUnderscoresActionSchema: GenEnum<HttpProtocolOptions_HeadersWithUnderscoresAction>;
 ...
 */
export declare type Http1ProtocolOptions = Message<"envoy.config.core.v3.Http1ProtocolOptions"> & {
  /**
   ...
   * are lower cased.
   *
   * @generated from field: envoy.config.core.v3.Http1ProtocolOptions.HeaderKeyFormat header_key_format = 4;
   */
   ...
   * is present.]
   *
   * @generated from field: bool allow_chunked_length = 6;
   */
   ...
   *
   * @generated from field: google.protobuf.BoolValue override_stream_error_on_invalid_http_message = 7;
   */
   ...
   *
   * @generated from field: bool send_fully_qualified_url = 8;
   */
   ...
   * See issue #21245.
   *
   * @generated from field: google.protobuf.BoolValue use_balsa_parser = 9 [deprecated = true];
   * @deprecated
   */
  useBalsaParser?: boolean;
   ...
   *
   * @generated from field: bool allow_custom_methods = 10;
   */
   ...
   *
   * @generated from field: repeated envoy.type.matcher.v3.StringMatcher ignore_http_11_upgrade = 11;
   */
  ignoreHttp11Upgrade: StringMatcher[];
};
 ...
 */
export declare const Http1ProtocolOptionsSchema: GenMessage<Http1ProtocolOptions>;
 ...
 */
export declare type Http1ProtocolOptions_HeaderKeyFormat = Message<"envoy.config.core.v3.Http1ProtocolOptions.HeaderKeyFormat"> & {
  /**
   * @generated from oneof envoy.config.core.v3.Http1ProtocolOptions.HeaderKeyFormat.header_format
   */
  headerFormat: {
    /**
     ...
     *
     * @generated from field: envoy.config.core.v3.Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords proper_case_words = 1;
     */
     ...
     *
     * @generated from field: envoy.config.core.v3.TypedExtensionConfig stateful_formatter = 8;
     */
    value: TypedExtensionConfig;
    case: "statefulFormatter";
 ...
 */
export declare const Http1ProtocolOptions_HeaderKeyFormatSchema: GenMessage<Http1ProtocolOptions_HeaderKeyFormat>;

/**
 * @generated from message envoy.config.core.v3.Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords
 */
export declare type Http1ProtocolOptions_HeaderKeyFormat_ProperCaseWords = Message<"envoy.config.core.v3.Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords"> & {
};
 ...
 */
export declare const Http1ProtocolOptions_HeaderKeyFormat_ProperCaseWordsSchema: GenMessage<Http1ProtocolOptions_HeaderKeyFormat_ProperCaseWords>;

/**
 * @generated from message envoy.config.core.v3.KeepaliveSettings
 */
export declare type KeepaliveSettings = Message<"envoy.config.core.v3.KeepaliveSettings"> & {
  /**
   ...
   *
   * @generated from field: envoy.type.v3.Percent interval_jitter = 3;
   */
   ...
   *
   * @generated from field: google.protobuf.Duration connection_idle_interval = 4;
   */
 ...
 */
export declare const KeepaliveSettingsSchema: GenMessage<KeepaliveSettings>;
 ...
 */
export declare type Http2ProtocolOptions = Message<"envoy.config.core.v3.Http2ProtocolOptions"> & {
  /**
   ...
   *
   * @generated from field: bool stream_error_on_invalid_http_messaging = 12 [deprecated = true];
   * @deprecated
   */
   ...
   * See `RFC7540, sec. 8.1 <https://tools.ietf.org/html/rfc7540#section-8.1>`_ for details.
   *
   * @generated from field: google.protobuf.BoolValue override_stream_error_on_invalid_http_message = 14;
   */
  overrideStreamErrorOnInvalidHttpMessage?: boolean;
   ...
   *
   * @generated from field: repeated envoy.config.core.v3.Http2ProtocolOptions.SettingsParameter custom_settings_parameters = 13;
   */
   ...
   *
   * @generated from field: envoy.config.core.v3.KeepaliveSettings connection_keepalive = 15;
   */
   ...
   *
   * @generated from field: google.protobuf.BoolValue use_oghttp2_codec = 16;
   */
  useOghttp2Codec?: boolean;

  /**
   * Configure the maximum amount of metadata than can be handled per stream. Defaults to 1 MB.
   *
   * @generated from field: google.protobuf.UInt64Value max_metadata_size = 17;
   */
  maxMetadataSize?: bigint;
};
 ...
 */
export declare const Http2ProtocolOptionsSchema: GenMessage<Http2ProtocolOptions>;
 ...
 */
export declare type Http2ProtocolOptions_SettingsParameter = Message<"envoy.config.core.v3.Http2ProtocolOptions.SettingsParameter"> & {
  /**
 ...
 */
export declare const Http2ProtocolOptions_SettingsParameterSchema: GenMessage<Http2ProtocolOptions_SettingsParameter>;
 ...
 */
export declare type GrpcProtocolOptions = Message<"envoy.config.core.v3.GrpcProtocolOptions"> & {
  /**
   * @generated from field: envoy.config.core.v3.Http2ProtocolOptions http2_protocol_options = 1;
   */
 ...
 */
export declare const GrpcProtocolOptionsSchema: GenMessage<GrpcProtocolOptions>;
 ...
 */
export declare type Http3ProtocolOptions = Message<"envoy.config.core.v3.Http3ProtocolOptions"> & {
  /**
   ...
   * <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.stream_error_on_invalid_http_message>`.
   *
   * @generated from field: google.protobuf.BoolValue override_stream_error_on_invalid_http_message = 2;
   */
  overrideStreamErrorOnInvalidHttpMessage?: boolean;
   ...
   *
   * @generated from field: bool allow_extended_connect = 5;
   */
   ...
   *
   * @generated from field: bool disable_qpack = 7;
   */
  disableQpack: boolean;
   ...
   *
   * @generated from field: bool disable_connection_flow_control_for_streams = 8;
   */
  disableConnectionFlowControlForStreams: boolean;
};
 ...
 */
export declare const Http3ProtocolOptionsSchema: GenMessage<Http3ProtocolOptions>;
 ...
 */
export declare type SchemeHeaderTransformation = Message<"envoy.config.core.v3.SchemeHeaderTransformation"> & {
  /**
   * @generated from oneof envoy.config.core.v3.SchemeHeaderTransformation.transformation
   */
  transformation: {
    /**
     ...
     *
     * @generated from field: string scheme_to_overwrite = 1;
     */
    value: string;
    case: "schemeToOverwrite";
  } | { case: undefined; value?: undefined };
   ...
   *
   * @generated from field: bool match_upstream = 2;
   */
  matchUpstream: boolean;
};
 ...
 */
export declare const SchemeHeaderTransformationSchema: GenMessage<SchemeHeaderTransformation>;
