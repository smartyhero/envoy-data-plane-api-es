...
import type { RoutingPriority } from "../../core/v3/base_pb";
import type { Percent } from "../../../type/v3/percent_pb";

/**
 * Describes the file envoy/config/cluster/v3/circuit_breaker.proto.
 */
export declare const file_envoy_config_cluster_v3_circuit_breaker: GenFile;
 ...
 */
export declare type CircuitBreakers = Message<"envoy.config.cluster.v3.CircuitBreakers"> & {
  /**
 ...
 */
export declare type CircuitBreakers_Thresholds = Message<"envoy.config.cluster.v3.CircuitBreakers.Thresholds"> & {
  /**
 ...
 */
export declare type CircuitBreakers_Thresholds_RetryBudget = Message<"envoy.config.cluster.v3.CircuitBreakers.Thresholds.RetryBudget"> & {
  /**
