 ...
 */
export declare const file_envoy_config_cluster_redis_redis_cluster: GenFile;
 ...
 */
export declare type RedisClusterConfig = Message<"envoy.config.cluster.redis.RedisClusterConfig"> & {
  /**
