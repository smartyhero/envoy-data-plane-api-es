...
import type { HealthStatus } from "../../core/v3/health_check_pb";
import type { Locality, Metadata } from "../../core/v3/base_pb";
 ...
 */
export declare const file_envoy_config_endpoint_v3_endpoint_components: GenFile;
 ...
 */
export declare type Endpoint = Message<"envoy.config.endpoint.v3.Endpoint"> & {
  /**
 ...
 */
export declare type Endpoint_HealthCheckConfig = Message<"envoy.config.endpoint.v3.Endpoint.HealthCheckConfig"> & {
  /**
 ...
 */
export declare const Endpoint_HealthCheckConfigSchema: GenMessage<Endpoint_HealthCheckConfig>;

/**
 * @generated from message envoy.config.endpoint.v3.Endpoint.AdditionalAddress
 */
export declare type Endpoint_AdditionalAddress = Message<"envoy.config.endpoint.v3.Endpoint.AdditionalAddress"> & {
  /**
 ...
 */
export declare const Endpoint_AdditionalAddressSchema: GenMessage<Endpoint_AdditionalAddress>;
 ...
 */
export declare type LbEndpoint = Message<"envoy.config.endpoint.v3.LbEndpoint"> & {
  /**
 ...
 */
export declare const LbEndpointSchema: GenMessage<LbEndpoint>;

/**
 * LbEndpoint list collection. Entries are `LbEndpoint` resources or references.
 * [#not-implemented-hide:]
 *
 * @generated from message envoy.config.endpoint.v3.LbEndpointCollection
 */
export declare type LbEndpointCollection = Message<"envoy.config.endpoint.v3.LbEndpointCollection"> & {
  /**
 ...
 */
export declare const LbEndpointCollectionSchema: GenMessage<LbEndpointCollection>;
 ...
 */
export declare type LedsClusterLocalityConfig = Message<"envoy.config.endpoint.v3.LedsClusterLocalityConfig"> & {
  /**
 ...
 */
export declare const LedsClusterLocalityConfigSchema: GenMessage<LedsClusterLocalityConfig>;
 ...
 */
export declare type LocalityLbEndpoints = Message<"envoy.config.endpoint.v3.LocalityLbEndpoints"> & {
  /**
  ...
  lbConfig: {
     ...
     *
     * @generated from field: envoy.config.endpoint.v3.LocalityLbEndpoints.LbEndpointList load_balancer_endpoints = 7 [deprecated = true];
     * @deprecated
     */
 ...
 */
export declare const LocalityLbEndpointsSchema: GenMessage<LocalityLbEndpoints>;
 ...
 */
export declare type LocalityLbEndpoints_LbEndpointList = Message<"envoy.config.endpoint.v3.LocalityLbEndpoints.LbEndpointList"> & {
  /**
 ...
 */
export declare const LocalityLbEndpoints_LbEndpointListSchema: GenMessage<LocalityLbEndpoints_LbEndpointList>;
