...
import type { Metadata, TransportSocket } from "../../core/v3/base_pb";
import type { Int32Range } from "../../../type/v3/range_pb";

/**
 * Describes the file envoy/config/listener/v3/listener_components.proto.
 */
export declare const file_envoy_config_listener_v3_listener_components: GenFile;
 ...
 */
export declare type Filter = Message<"envoy.config.listener.v3.Filter"> & {
  /**
 ...
 */
export declare type FilterChainMatch = Message<"envoy.config.listener.v3.FilterChainMatch"> & {
  /**
 ...
 */
export declare type FilterChain = Message<"envoy.config.listener.v3.FilterChain"> & {
  /**
 ...
 */
export declare type ListenerFilterChainMatchPredicate = Message<"envoy.config.listener.v3.ListenerFilterChainMatchPredicate"> & {
  /**
 ...
 */
export declare type ListenerFilterChainMatchPredicate_MatchSet = Message<"envoy.config.listener.v3.ListenerFilterChainMatchPredicate.MatchSet"> & {
  /**
 ...
 */
export declare type ListenerFilter = Message<"envoy.config.listener.v3.ListenerFilter"> & {
  /**
   * The name of the filter configuration.
   *
   * @generated from field: string name = 1;
