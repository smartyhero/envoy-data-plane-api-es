 ...
 */
export declare const file_envoy_config_metrics_v2_stats: GenFile;

/**
 * Configuration for pluggable stats sinks.
 *
 * @generated from message envoy.config.metrics.v2.StatsSink
 */
export declare type StatsSink = Message<"envoy.config.metrics.v2.StatsSink"> & {
  /**
   ...
   *
   * @generated from oneof envoy.config.metrics.v2.StatsSink.config_type
   */
  configType: {
    /**
 ...
 *
 * @generated from message envoy.config.metrics.v2.StatsConfig
 */
export declare type StatsConfig = Message<"envoy.config.metrics.v2.StatsConfig"> & {
  /**
   ...
   *
   * @generated from field: repeated envoy.config.metrics.v2.TagSpecifier stats_tags = 1;
   */
   ...
   *
   * @generated from field: envoy.config.metrics.v2.StatsMatcher stats_matcher = 3;
   */
 ...
 *
 *
 * @generated from message envoy.config.metrics.v2.StatsMatcher
 */
export declare type StatsMatcher = Message<"envoy.config.metrics.v2.StatsMatcher"> & {
  /**
   * @generated from oneof envoy.config.metrics.v2.StatsMatcher.stats_matcher
   */
  statsMatcher: {
    /**
     ...
     *
     * @generated from field: envoy.type.matcher.ListStringMatcher exclusion_list = 2;
     */
     ...
     * StringMatcher protos.
     *
     * @generated from field: envoy.type.matcher.ListStringMatcher inclusion_list = 3;
     */
    value: ListStringMatcher;
    case: "inclusionList";
  } | { case: undefined; value?: undefined };
 ...
 *
 * @generated from message envoy.config.metrics.v2.TagSpecifier
 */
export declare type TagSpecifier = Message<"envoy.config.metrics.v2.TagSpecifier"> & {
  /**
  ...
  /**
   * @generated from oneof envoy.config.metrics.v2.TagSpecifier.tag_value
   */
  tagValue: {
    /**
 ...
 *
 * @generated from message envoy.config.metrics.v2.StatsdSink
 */
export declare type StatsdSink = Message<"envoy.config.metrics.v2.StatsdSink"> & {
  /**
   * @generated from oneof envoy.config.metrics.v2.StatsdSink.statsd_specifier
   */
  statsdSpecifier: {
    /**
 ...
 *
 * @generated from message envoy.config.metrics.v2.DogStatsdSink
 */
export declare type DogStatsdSink = Message<"envoy.config.metrics.v2.DogStatsdSink"> & {
  /**
   * @generated from oneof envoy.config.metrics.v2.DogStatsdSink.dog_statsd_specifier
   */
  dogStatsdSpecifier: {
    /**
 ...
 *
 * @generated from message envoy.config.metrics.v2.HystrixSink
 */
export declare type HystrixSink = Message<"envoy.config.metrics.v2.HystrixSink"> & {
  /**
