...
import type { HashPolicy } from "../../../../../type/hash_policy_pb";
 ...
 */
export declare const file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy: GenFile;
 ...
 */
export declare type TcpProxy = Message<"envoy.config.filter.network.tcp_proxy.v2.TcpProxy"> & {
  /**
 ...
 * @deprecated
 */
export declare type TcpProxy_DeprecatedV1 = Message<"envoy.config.filter.network.tcp_proxy.v2.TcpProxy.DeprecatedV1"> & {
  /**
 ...
 * @deprecated
 */
export declare const TcpProxy_DeprecatedV1Schema: GenMessage<TcpProxy_DeprecatedV1>;
 ...
 * @deprecated
 */
export declare type TcpProxy_DeprecatedV1_TCPRoute = Message<"envoy.config.filter.network.tcp_proxy.v2.TcpProxy.DeprecatedV1.TCPRoute"> & {
  /**
 ...
 * @deprecated
 */
export declare const TcpProxy_DeprecatedV1_TCPRouteSchema: GenMessage<TcpProxy_DeprecatedV1_TCPRoute>;
 ...
 */
export declare type TcpProxy_WeightedCluster = Message<"envoy.config.filter.network.tcp_proxy.v2.TcpProxy.WeightedCluster"> & {
  /**
 ...
 */
export declare type TcpProxy_WeightedCluster_ClusterWeight = Message<"envoy.config.filter.network.tcp_proxy.v2.TcpProxy.WeightedCluster.ClusterWeight"> & {
  /**
 ...
 */
export declare type TcpProxy_TunnelingConfig = Message<"envoy.config.filter.network.tcp_proxy.v2.TcpProxy.TunnelingConfig"> & {
  /**
