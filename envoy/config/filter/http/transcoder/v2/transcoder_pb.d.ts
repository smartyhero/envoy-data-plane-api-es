 ...
 */
export declare const file_envoy_config_filter_http_transcoder_v2_transcoder: GenFile;
 ...
 */
export declare type GrpcJsonTranscoder = Message<"envoy.config.filter.http.transcoder.v2.GrpcJsonTranscoder"> & {
  /**
 ...
 */
export declare type GrpcJsonTranscoder_PrintOptions = Message<"envoy.config.filter.http.transcoder.v2.GrpcJsonTranscoder.PrintOptions"> & {
  /**
