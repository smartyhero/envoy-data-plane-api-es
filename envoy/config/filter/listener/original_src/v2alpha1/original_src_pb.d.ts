 ...
 */
export declare const file_envoy_config_filter_listener_original_src_v2alpha1_original_src: GenFile;
 ...
 */
export declare type OriginalSrc = Message<"envoy.config.filter.listener.original_src.v2alpha1.OriginalSrc"> & {
  /**
