 ...
 */
export declare const file_envoy_config_retry_previous_priorities_previous_priorities_config: GenFile;
 ...
 *
 * @generated from message envoy.config.retry.previous_priorities.PreviousPrioritiesConfig
 */
export declare type PreviousPrioritiesConfig = Message<"envoy.config.retry.previous_priorities.PreviousPrioritiesConfig"> & {
  /**
