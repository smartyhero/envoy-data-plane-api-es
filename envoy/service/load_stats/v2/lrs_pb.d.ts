...
import type { ClusterStats } from "../../../api/v2/endpoint/load_report_pb";
import type { Duration } from "@bufbuild/protobuf/wkt";

/**
 * Describes the file envoy/service/load_stats/v2/lrs.proto.
 */
export declare const file_envoy_service_load_stats_v2_lrs: GenFile;
 ...
 */
export declare type LoadStatsRequest = Message<"envoy.service.load_stats.v2.LoadStatsRequest"> & {
  /**
 ...
 */
export declare type LoadStatsResponse = Message<"envoy.service.load_stats.v2.LoadStatsResponse"> & {
  /**
...
export declare const LoadReportingService: GenService<{
   ...
   *
   * @generated from rpc envoy.service.load_stats.v2.LoadReportingService.StreamLoadStats
   */
  streamLoadStats: {
