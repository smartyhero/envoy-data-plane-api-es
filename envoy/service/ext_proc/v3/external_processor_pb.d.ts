...
import type { ProcessingMode, ProcessingMode_BodySendMode } from "../../../extensions/filters/http/ext_proc/v3/processing_mode_pb";
import type { HeaderMap, HeaderValueOption, Metadata } from "../../../config/core/v3/base_pb";
 ...
 */
export declare type ProtocolConfiguration = Message<"envoy.service.ext_proc.v3.ProtocolConfiguration"> & {
  /**
 ...
 */
export declare type ProcessingRequest = Message<"envoy.service.ext_proc.v3.ProcessingRequest"> & {
  /**
 ...
 */
export declare type ProcessingResponse = Message<"envoy.service.ext_proc.v3.ProcessingResponse"> & {
  /**
 ...
 */
export declare type HttpHeaders = Message<"envoy.service.ext_proc.v3.HttpHeaders"> & {
  /**
 ...
 */
export declare type HttpBody = Message<"envoy.service.ext_proc.v3.HttpBody"> & {
  /**
 ...
 */
export declare type HttpTrailers = Message<"envoy.service.ext_proc.v3.HttpTrailers"> & {
  /**
   * The header value is encoded in the
   * :ref:`raw_value <envoy_v3_api_field_config.core.v3.HeaderValue.raw_value>` field.
   *
 ...
 */
export declare type HeadersResponse = Message<"envoy.service.ext_proc.v3.HeadersResponse"> & {
  /**
 ...
 */
export declare type BodyResponse = Message<"envoy.service.ext_proc.v3.BodyResponse"> & {
  /**
   * Details the modifications (if any) to be made by the data plane to the current
   * request/response.
   *
 ...
 */
export declare type TrailersResponse = Message<"envoy.service.ext_proc.v3.TrailersResponse"> & {
  /**
   * Details the modifications (if any) to be made by the data plane to the current
 ...
 */
export declare type CommonResponse = Message<"envoy.service.ext_proc.v3.CommonResponse"> & {
  /**
 ...
 */
export declare type ImmediateResponse = Message<"envoy.service.ext_proc.v3.ImmediateResponse"> & {
  /**
 ...
 */
export declare type GrpcStatus = Message<"envoy.service.ext_proc.v3.GrpcStatus"> & {
  /**
 ...
 */
export declare type HeaderMutation = Message<"envoy.service.ext_proc.v3.HeaderMutation"> & {
  /**
 ...
 */
export declare type StreamedBodyResponse = Message<"envoy.service.ext_proc.v3.StreamedBodyResponse"> & {
  /**
 ...
 */
export declare type BodyMutation = Message<"envoy.service.ext_proc.v3.BodyMutation"> & {
  /**
