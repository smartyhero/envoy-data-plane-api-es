 ...
 */
export declare const file_envoy_service_event_reporting_v2alpha_event_reporting_service: GenFile;
 ...
 */
export declare type StreamEventsRequest = Message<"envoy.service.event_reporting.v2alpha.StreamEventsRequest"> & {
  /**
   * Identifier data that will only be sent in the first message on the stream. This is effectively
   * structured metadata and is a performance optimization.
   *
   * @generated from field: envoy.service.event_reporting.v2alpha.StreamEventsRequest.Identifier identifier = 1;
   */
 ...
 */
export declare type StreamEventsRequest_Identifier = Message<"envoy.service.event_reporting.v2alpha.StreamEventsRequest.Identifier"> & {
  /**
 ...
 */
export declare type StreamEventsResponse = Message<"envoy.service.event_reporting.v2alpha.StreamEventsResponse"> & {
};
...
export declare const EventReportingService: GenService<{
   ...
   *
   * @generated from rpc envoy.service.event_reporting.v2alpha.EventReportingService.StreamEvents
   */
  streamEvents: {
